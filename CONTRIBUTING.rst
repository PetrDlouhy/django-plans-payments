...
Django plans payments could always use more documentation, whether as part of the 
official Django plans payments docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.6, 2.7, and 3.3, and for PyPy. Check 
   https://travis-ci.org/PetrDlouhy/django-plans-payments/pull_requests
